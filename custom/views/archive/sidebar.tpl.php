...
<div id="sidebar" class="aside">
    <div id="sidebar-people" class="section">
        <h2>All Feeds (<?php echo count($all_people); ?>)</h2>
        <ul>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li><img src="custom/img/feed.png" alt="feed" height="12" width="12" /> <a href="custom/people.opml">All feeds in OPML format</a></li>
        </ul>
    </div>
    ...
    <div class="section">
        <h2>Archives</h2>
        <ul>
            <li><img src="custom/img/list.png" alt="feed" height="12" width="12" />&nbsp;<a href="?type=archive">See all headlines</a></li>
        </ul>
    </div>
</div>